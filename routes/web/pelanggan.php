...
// Guest checkout bisa bikin, upgrade, & bayar pesanan tanpa login. Rute-rute
// ini dulu ada di grup middleware auth+verified sehingga tamu yang sudah
// sampai halaman upgrade/payment-method (guest-accessible) malah kena 401
// saat submit. Sekarang guest boleh akses, tapi assertGuestOwnsOrderInSession()
// di service layer memastikan guest cuma bisa memproses order yang benar-benar
// mereka buat sendiri di sesi ini (bukan order sembarangan milik orang lain
// yang ID/nota-nya kebetulan diketahui).
