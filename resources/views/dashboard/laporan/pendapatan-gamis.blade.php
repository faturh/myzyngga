                    ...
                    <div class="overflow-x-auto p-0 px-6 pb-6">
                        ...
                        <div>
                            ...
                            <label class="form-control w-full">
                                ...
                                <input type="text" name="total_pendapatan_laundry" value="Rp{{ number_format($transaksi->sum('upah'), 2, ',', '.') }}" class="input input-bordered w-full text-blue-700 dark:bg-slate-100" readonly />
                            </label>
                        </div>
                    </div>
                </div>
