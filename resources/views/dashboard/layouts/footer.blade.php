        ...
        <div class="-mx-3 flex flex-wrap items-center lg:justify-between">
            <div class="mb-6 mt-0 w-full max-w-full shrink-0 px-3 lg:mb-0 lg:w-1/2 lg:flex-none">
                <div class="text-center text-sm leading-normal text-slate-500 lg:text-left">
                    ...
                    <a href="https://github.com/faturh" class="font-semibold text-slate-700 dark:text-white" target="_blank">faturh</a>
                    for a better web.
                </div>
            </div>
            <div class="mt-0 w-full max-w-full shrink-0 px-3 lg:flex-none">
                <ul class="mb-0 flex list-none flex-wrap justify-center pl-0 lg:justify-end">
                    <li class="nav-item">
                        <a href="https://github.com/faturh" class="block px-4 pb-1 pt-0 text-sm font-normal text-slate-500 transition-colors ease-in-out" target="_blank">GitHub</a>
                    </li>
                </ul>
            </div>
        </div>
