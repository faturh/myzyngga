        ...
        <div class="max-w-5xl mx-auto px-5 pt-8 pb-8 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="space-y-1">
                    ...
                    <x-zyngga-text variant="sm" color="neutral-500">Jl. Sukabirus No. 99</x-zyngga-text>
                </div>
                <div class="space-y-1">
                    <x-zyngga-text variant="base" weight="medium">Sukapura</x-zyngga-text>
                    <x-zyngga-text variant="sm" color="neutral-500">Jl. Sukapura No. 97</x-zyngga-text>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <ul class="space-y-0">
                        ...
                        <li class="h-7 flex items-center">
                            <x-zyngga-text variant="sm" color="neutral-500">Layanan</x-zyngga-text>
                        </li>
                        <li class="h-7 flex items-center">
                            <x-zyngga-text variant="sm" color="neutral-500">Langganan</x-zyngga-text>
                        </li>
                    </ul>
                </div>
            </div>
