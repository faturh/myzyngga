...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @close.stop="open = false">
    ...
    <div x-show="open"
            ...
            class="absolute z-50 mt-2 <?php echo e($width); ?> rounded-[12px] shadow-[0_8px_30px_rgba(0,0,0,0.12)] border border-zyngga-neutral-200 overflow-hidden <?php echo e($alignmentClasses); ?>"
            style="display: none;"
            @click="open = false">
...
<?php /**PATH C:\Users\mrafi\OneDrive\Documents\Zyngga\resources\views/components/dropdown.blade.php ENDPATH**/ ?>