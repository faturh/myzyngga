...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.zyngga-input','data' => ['label' => 'Password','wire:model' => 'password','id' => 'password','name' => 'password','type' => 'password','class' => 'w-3/4','placeholder' => 'Password','error' => $errors->first('password')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Password','wire:model' => 'password','id' => 'password','name' => 'password','type' => 'password','class' => 'w-3/4','placeholder' => 'Password','error' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->first('password'))]); ?>
...
<?php endif; ?>
</section><?php /**PATH C:\Users\mrafi\OneDrive\Documents\Zyngga\resources\views\livewire/profile/delete-user-form.blade.php ENDPATH**/ ?>